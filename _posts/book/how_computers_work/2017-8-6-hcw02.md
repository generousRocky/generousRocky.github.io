...
###### 3. 컴퓨터의 모든 구성요소는 각자의 할 일을 정해진 time stamp 마다 수행할 수 있다. 이 time stamp를 clock cycle또는 systme clock sycle이라고 한다. 이 clock cycle의 주기에 따라 프로세서는 전기 pulse를 보내거나 받아서 정보(이진수 bits)를 쓰거나 읽는다.
...
<p style="text-align: center;">
	<img src="{{ site.url }}/images/hcw02_15.png" alt="Drawing" style="width: 800px;"/>
</p>
